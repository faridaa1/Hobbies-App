        ...
        <div class="d-flex flex-column w-100">
            <div class="d-flex flex-column gap-2">
                ...
                <div class="d-flex">
                    ...
                    <button name="name_save" type="button" :disabled="!validName" v-if="isEditingName"class="btn btn-success me-1" @click="console.log("ok");updateProfile($event)">Save</button>
